#NVDAExtensionGlobalPlugin/keyboardKeyRenaming/__init__.py
...
class KeyboardKeyRenamingDialog(SettingsDialog):
	...
	def makeSettings(self, settingsSizer):
		...
		# Translators: The label for the list box in KeyboardKeyRenaming Dialog to select a key label.
		keyLabelsListlabelText = _("NVDA defined key labels:")
		self.keyLabelsList=sHelper.addLabeledControl(keyLabelsListlabelText , wx.ListBox, id = wx.ID_ANY, name="NVDAKeyLabels", choices= self.localizedLabels)
