...
scriptsToDocInformations = {
	...
	"shutdownComputerDialog": (_("Display the dialog to shutdown, reboot or hibernate the computer"), None, "hdr19"),
	# Translators: Input help mode message
	...
	"foregroundWindowObjectsList": (_("Display the list's visible items making up current foreground object"), globalCommands.SCRCAT_FOCUS, "hdr16"),
	# Translators: Input help mode message
	...
	"report_SystrayIconsOrWindowsList": (_("{systrayIconsDoc}. Twice, {activeWindowsDoc}").format(systrayIconsDoc=systrayIconsDoc, activeWindowsDoc=activeWindowsDoc), None, "hdr1-3"),
	# Translators: Input help mode message
	# for report current application name and version command.
	"reportAppProductNameAndVersion": (_("Report the application 's name and version"), globalCommands.SCRCAT_TOOLS, None),
	# Translators: Input help mode message
	# for report current program name and app module name or current configuration profile name command.
	"reportAppModuleInfoEx": (_("Speaks the filename of the active application along with the name of the currently loaded appModule python file. Pressing this key twice,speak the name and state of the current configuration profile"), globalCommands.SCRCAT_TOOLS, None),
	# Translators: Input help mode message
	# for report current addon's name and version command.
	"reportCurrentAddonNameAndVersion": (_("Report the name and version number of add-on activated for focused application"), globalCommands.SCRCAT_TOOLS, None),
	# Translators: Input help mode message
	# for displayt current program informations dialog command.
	"DisplayAppModuleInfo": (_("Display informations about the focused application"), globalCommands.SCRCAT_TOOLS, "hdr4-2"),
	# Translators: Input help mode message
	# for display minute timer dialog command.
	"minuteTimer": (_("Display dialog to start the minute timer. If minute timer already started, display dialog to report duration"), None, "hdr14"),
	# Translators: Input help mode message
	...
	"openCurrentOrOldNVDALogFile": (_("Open current NVDA log file. Pressing this key twice, open the old NVDA log file. Pressing third, copy current log path to the clipboard"), globalCommands.SCRCAT_TOOLS, "hdr9-2"),
	# Translators: Input help mode message
	# for report current folder command in open or save dialog box.
	"reportCurrentFolder": (_("report the name of current selected folder in the open or Save dialog box. Twice: report full path"), None, None),
	# Translators: Input help mode message
	# for report current folder name command in open or save dialog box.
	"reportCurrentFolderName": (_("report the name of current selected folder in the open or Save dialog box"), None, "hdr8"),
	# Translators: Input help mode message
	# for report current folder path command in open or save dialog box.
	"reportCurrentFolderFullPath": (_("report the full path of current selected folder in the open or Save dialog box"), None, "hdr8"),
	# Translators: Input help mode message
	...
	"displaySpeechHistoryRecords": (_("Display speech history records"), globalCommands.SCRCAT_SPEECH, "hdr10-1"),
	# Translators: Input help mode message
	# for report previous speech history record command.
	"reportPreviousSpeechHistoryRecord": (_("Report previous record of the speech history and copy it to clipboard"), globalCommands.SCRCAT_SPEECH, "hdr10"),
	# Translators: Input help mode message
	# for report current speech history record command.
	"reportCurrentSpeechHistoryRecord": (_("Report current record of the speech history and copy it to clipboard. Twice: display speech history"), globalCommands.SCRCAT_SPEECH, "hdr10"),
	# Translators: Input help mode message
	# for report next speech history record command.
	"reportNextSpeechHistoryRecord": (_("Report next record of the speech history and copy it to clipboard"), globalCommands.SCRCAT_SPEECH, "hdr10"),
	# Translators: Input help mode message
	...
	"toggleSwitchVoiceProfileMode": (_("Toggle voice profile switch mode"), SCRCAT_SWITCH_VOICE_PROFILE, "hdr17-2"),
	# Translators: Input help mode message
	# for display voice profile management dialog command.
	"manageVoiceProfileSelectors": (_("Display dialog to manage voice profile selectors"), SCRCAT_SWITCH_VOICE_PROFILE, "hdr17-1"),
	# Translators: Input help mode message
	# for go to previous voice profile selector command.
	"previousVoiceProfile": (_("Go backward to the first selector associated to a voice profile and set this voice profile as current voice profile"), SCRCAT_SWITCH_VOICE_PROFILE, "hdr17"),
	# Translators: Input help mode message
	# for go to next voice profile selector command.
	"nextVoiceProfile": (_("Go to forward to the first selector associated to a voice profile and set this voice profile as current voice profile"), SCRCAT_SWITCH_VOICE_PROFILE, "hdr17"),
	# Translators: Input help mode message
	...
	"dateTimeEx": (_("Report the current time. Twice: report the current date. Third: copy date and time to the clipboard"), globalCommands.SCRCAT_SYSTEM, "hdr24-2"),
	# Translators: Input help mode message
	...
	"displayFormatting": (_("Display, in dialog box, formatting informations for the current review cursor position within a document"), None, "hdr203"),
	# Translators: Input help mode message
	...
	"setVoiceProfileSelector1": (_("Set selector 1 as current selector and set, if possible, its associated voice profile as current voice profile"), SCRCAT_SWITCH_VOICE_PROFILE, "hdr17"),
	# Translators: Input help mode message
	# for set VoiceProfile Selector 2 command.
	"setVoiceProfileSelector2": (_("Set selector 2 as current selector and set, if possible, its associated voice profile as current voice profile"), SCRCAT_SWITCH_VOICE_PROFILE, "hdr17"),
	# Translators: Input help mode message
	# for set VoiceProfile Selector 3 command.
	"setVoiceProfileSelector3": (_("Set selector 3 as current selector and set, if possible, its associated voice profile as current voice profile"), SCRCAT_SWITCH_VOICE_PROFILE, "hdr17"),
	# Translators: Input help mode message
	# for set VoiceProfile Selector 4 command.
	"setVoiceProfileSelector4": (_("Set selector 4 as current selector and set, if possible, its associated voice profile as current voice profile"), SCRCAT_SWITCH_VOICE_PROFILE, "hdr17"),
	# Translators: Input help mode message
	# for set VoiceProfile Selector 5 command.
	"setVoiceProfileSelector5": (_("Set selector 5 as current selector and set, if possible, its associated voice profile as current voice profile"), SCRCAT_SWITCH_VOICE_PROFILE, "hdr17"),
	# Translators: Input help mode message
	# for set VoiceProfile Selector 6 command.
	"setVoiceProfileSelector6": (_("Set selector 6 as current selector and set, if possible, its associated voice profile as current voice profile"), SCRCAT_SWITCH_VOICE_PROFILE, "hdr17"),
	# Translators: Input help mode message
	# for set VoiceProfile Selector 7 command.
	"setVoiceProfileSelector7": (_("Set selector 7 as current selector and set, if possible, its associated voice profile as current voice profile"), SCRCAT_SWITCH_VOICE_PROFILE, "hdr17"),
	# Translators: Input help mode message
	# for set VoiceProfile Selector 8 command.
	"setVoiceProfileSelector8": (_("Set selector 8 as current selector and set, if possible, its associated voice profile as current voice profile"), SCRCAT_SWITCH_VOICE_PROFILE, "hdr17"),
	# Translators: Input help mode message
	# for activate user input gesture dialog command.
	"activateUserInputGesturesDialog": (_("Displays the dialog to manage the input gestures configured by user"), None, "hdr20"),
	# Translators: Input help mode message
	...
	"leftClickAtNavigatorObjectPosition": (_("Click the left mouse button at navigator object position. Twice: click twice this button at this position"), globalCommands.SCRCAT_MOUSE, "hdr23"),
	# Translators: Input help mode message
	# for right click mouse button at navigator cursor position script command.
	"rightClickAtNavigatorObjectPosition": (_("Click the right mouse button at navigator object position. Twice: click twice this button at this position"), globalCommands.SCRCAT_MOUSE, "hdr23"),
	# Translators: Input help mode message
	...
	"profileSettingsDialog": (_("Display settings dialog for current configuration profile"), None, "hdr-configurationMenu"),
	# Translators: Input help mode message
	...
	"reportOrDisplayCurrentSpeechSettings": (_("Report current speech settings. Twice: display them"), globalCommands.SCRCAT_SPEECH, "hdr17-6"),
	# Translators: Input help mode message
	# for reportCurrentSpeechSettings script commands.
	"reportCurrentSpeechSettings": (_("Report current speech settings"), globalCommands.SCRCAT_SPEECH, "hdr17-6"),
	# Translators: Input help mode message
	# for displayCurrentSpeechSettings script commands.
	"displayCurrentSpeechSettings": (_("Display current speech settings"), globalCommands.SCRCAT_SPEECH, "hdr17-6"),
	# Translators: Input help mode message
	...
	"toggleReportCurrentCaretPosition": (_("Toggle reporting of current caret position in edit box"), None, "hdr32"),
	# Translators: Input help mode message
	...
	"temporaryAudioOutputDeviceManager": (_("Display the temporary audio device manager"), globalCommands.SCRCAT_SPEECH, "hdr33-1"),
	# Translators: Input help mode message
	# for cancel temporary audio device script commands.
	"cancelTemporaryAudioOutputDevice": (_("Leave up the temporary audio device"), globalCommands.SCRCAT_SPEECH, "hdr33-3"),
	# Translators: Input help mode message
	# for set temporary audio device script commands.
	"setTemporaryAudioOutputDevice": (_("Set, as temporary audio device, the next device in the list of checked devices of the temporary audio device manager"), globalCommands.SCRCAT_SPEECH, "hdr33-2"),
	# Translators: Input help mode message
	# for set or cancel temporary audio device script commands.
	"setOrCancelTemporaryAudioOutputDevice": (_("Set, as temporary audio output device , the next device in the list of devices selected in the temporary audio output device manager. Twice: leave up the temporary audio output device"), globalCommands.SCRCAT_SPEECH, "hdr33-4"),
	...
	"toggleCurrentAppVolumeMute": (_("Toggle current focused application volume mute"), SCRCAT_VOLUME_CONTROL, "hdr21-2"),
	# Translators: Input help mode message
	# for increase volume of current focused application command.
	"increaseFocusedAppVolume": (_("Increase volume of current focused application"), SCRCAT_VOLUME_CONTROL, "hdr21-3"),
	# Translators: Input help mode message
	# for decrease volume of current focused application command.
	"decreaseFocusedAppVolume": (_("Decrease volume of current focused application"), SCRCAT_VOLUME_CONTROL, "hdr21-3"),
	# Translators: Input help mode message
	# for maximize volume of current focused application command.
	"maximizeFocusedAppVolume": (_("Maximize volume of current focused application"), SCRCAT_VOLUME_CONTROL, "hdr21-3"),
	# Translators: Input help mode message
	# for minimize volume of current focused application command.
	"minimizeFocusedAppVolume": (_("Minimize volume of current focused application"), SCRCAT_VOLUME_CONTROL, "hdr21-3"),
	# Translators: Input help mode message
	...
	"setFocusedAppVolumeToPreviousLevel": (_("Set the volume of current focused application to previous level"), SCRCAT_VOLUME_CONTROL, "hdr21-5"),
	# Translators: Input help mode message
	...
	"setSpeakersVolumeLevelToPreviousLevel": (_("Set the main volume to previous level"), SCRCAT_VOLUME_CONTROL, "hdr21-5"),
}
