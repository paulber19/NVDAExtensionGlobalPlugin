...
def autoUpdateCheck(releaseToDev):
	...
	if globalVars.appArgs.install or globalVars.appArgs.minimal: return
	...
	if currentTime < whenToCheck:return
	state.setLastCheck()
...
def addonUpdateCheck(auto, releaseToDev):
	...
	wx.CallAfter(CheckForAddonUpdate, addonName = None, updateInfosFile  = None, auto = auto, releaseToDev = releaseToDev)